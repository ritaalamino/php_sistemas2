...
<body>
    <div id="container">
        ...
        <form action="#" method="post" id="contact_form">
          ...
          <div class="cpf">
            <label for="cpf"></label>
            <input type="text" placeholder="CRM" name="CRM" id="crm_input" required>
          </div>
          <div class="telephone">
            <label for="name"></label>
          ...
          <div class="adress">
            <label for="adress"></label>
            <input type="text" placeholder="Especialidade" name="especialidade" id="especialidade_input" required>
          </div>
          <div class="subject">
